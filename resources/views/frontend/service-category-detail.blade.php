...
@section('meta_description', $category->description ? Str::limit(strip_tags($category->description), 160) : 'SR Greenscapes ' . $category->name . ' — specialist landscaping services in Bengaluru with science-driven design and sustainable solutions.')
@section('canonical_url', route('service.category.detail', [$service->slug, $category->slug]))
        ...
        <div class="scd-content-grid">
            ...
            <div class="scd-content-left" data-aos="fade-right">
                ...
                <div class="scd-content-img">
                    ...
                    @else
                        <img loading="lazy" src="{{ asset('images/Home/1.1Cover photo 1.jpg') }}" alt="{{ $category->name }}">
                    @endif
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    <a href="{{ route('service.subcategory.detail', [$service->slug, $category->slug, $sub->slug]) }}" class="scd-subcat-card">
                        <div class="scd-subcat-img">
                            ...
                            @else
                                <img loading="lazy" src="{{ $service->image ? asset('storage/' . $service->image) : asset('images/Home/1.1Cover photo 1.jpg') }}" alt="{{ $sub->name }}">
                            @endif
                        </div>
